...
const float STANDARD_EMOTION_RATE = 1.8;
const float EMOTION_SCORE_SCALE = 3.5;
const float STANDARD_END_BLANK_DELTA = 3;
const float END_BLANK_SCORE_SCALE = 2;
const float STANDARD_CONTINUOUS_BLANK_DELTA = 2;
