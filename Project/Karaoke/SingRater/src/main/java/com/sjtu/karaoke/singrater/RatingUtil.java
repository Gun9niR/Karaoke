...
public class RatingUtil {
    ...
    public static native String f0analysis(String filePath, int jstartTimeInMicroMS);
    ...
    public static native String getScore(int startTimeInMicroMS, int endTimeInMicroMS);
    ...
    public static native String init(String filePath, int splitTimeInMicroMS,
                              double delayLowerBound, double delayUpperBound);
